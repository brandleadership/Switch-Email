...
module.exports = cx.design
  ...
  .withContentElementGroups(
    ...
    cx.contentElementGroup
      ...
      .withLabel("Layout")
      .withContentElements(
        require("@bsi-cx/design-standard-library-email/content-elements/layout/layout-base").withExtendedDropzone(
        ...
        require("@bsi-cx/design-standard-library-email/content-elements/layout/col-one").withExtendedDropzone(
          "col-one-dropzone-GYTnrx",
          ...colOneElements
        ),
        require("@bsi-cx/design-standard-library-email/content-elements/layout/col-two")
          .withExtendedDropzone("col-two-dropzone-1-rRaE9R", ...colTwoElements)
          .withExtendedDropzone("col-two-dropzone-2-K1vkFU", ...colTwoElements),
        require("./content-elements/layout/col-two-ratio-1-2"),
    ...
    cx.contentElementGroup
      ...
      .withLabel("Buttons")
      .withContentElements(
        require("./content-elements/base/cta-left"),
    ...
    cx.contentElementGroup
      ...
      .withContentElements(
        require("@bsi-cx/design-standard-library-email/content-elements/base/highlighted-content").withExtendedDropzone(
    ...
    cx.contentElementGroup
      ...
      .withLabel("Footer")
      .withContentElements(
        require("./content-elements/layout/footer"),
        require("./content-elements/base/socials")
      )
  );
